...
$Folder = "C:\Users\saike\Desktop\pj-srvapi-affichageDynamique\api\scripts\aff-dyn-script\10_Carte_oubliee\paquets"
...
Write-Output "[Script terminé] Carte Oubliée"
$UdpClient.Close()