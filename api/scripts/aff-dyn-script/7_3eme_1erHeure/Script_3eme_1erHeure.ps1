...
$Folder = "C:\Users\saike\Desktop\pj-srvapi-affichageDynamique\api\scripts\aff-dyn-script\7_3eme_1erHeure\paquets"
...
Write-Output "[Script terminé] 3ème 1ère Heure"
$UdpClient.Close()