...
$Folder = "C:\Users\saike\Desktop\pj-srvapi-affichageDynamique\api\scripts\aff-dyn-script\8_6-5eme_2Heure\paquets"
...
Write-Output "[Script terminé] 6/5ème 2ème Heure"
$UdpClient.Close()