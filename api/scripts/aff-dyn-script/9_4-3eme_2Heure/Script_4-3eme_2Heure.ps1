...
$Folder = "C:\Users\saike\Desktop\pj-srvapi-affichageDynamique\api\scripts\aff-dyn-script\9_4-3eme_2Heure\paquets"
...
Write-Output "[Script terminé] 4/3ème 2ème Heure"
$UdpClient.Close()