...
$Folder = "C:\Users\saike\Desktop\pj-srvapi-affichageDynamique\api\scripts\aff-dyn-script\6_4eme_1erHeure\paquets"
...
Write-Output "[Script terminé] 4ème 1ère Heure"
$UdpClient.Close()