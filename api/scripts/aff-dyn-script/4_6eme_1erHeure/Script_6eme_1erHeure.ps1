...
$Folder = "C:\Users\saike\Desktop\pj-srvapi-affichageDynamique\api\scripts\aff-dyn-script\4_6eme_1erHeure\paquets"
...
Write-Output "[Script terminé] 6ème 1ère Heure"
$UdpClient.Close()